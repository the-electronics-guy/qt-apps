...
class MapDisplay(QMainWindow):
    ...
    def load_map(self):
            ...
            for node_id in self.node_ids:
                if node_id in interface.nodes:
                    ...
                    if latitude is not None and longitude is not None:
                        ...
                        nodes_data[node_id] = (latitude, longitude)
                    else:
        ...
        for node_id, (lat, lon) in nodes_data.items():
            nodes_js += f"""
                    var node_{node_id.replace("!", "")} = L.marker([{lat}, {lon}]).addTo(map);
                    node_{node_id.replace("!", "")}.bindPopup("Node {node_id}");
                """
        ...
        html_content = """
                ...
                <title>Leaflet Map with Satellite and Terrain Layers</title>
                ...
                <script>
                var map = L.map('map').setView([5.590039, -0.156270], 13);
                ...
                var satelliteOceanLayer = L.tileLayer('https://{s}.google.com/vt/lyrs=s,h&x={x}&y={y}&z={z}', {
                maxZoom: 20,
                subdomains: ['mt0', 'mt1', 'mt2', 'mt3']
                });
              ...
              var baseLayers = {
                ...
                "Hybrid": satelliteOceanLayer,
                "Street": googleStreets
              };

              // Feature Group and Layer Group for drawn items and nodes
              var drawnItems = new L.FeatureGroup();
              var nodes = L.layerGroup([
                L.marker([5.589984, -0.156367], {icon: L.icon({
                  iconUrl: '/img/node.png',
                  iconSize: [40, 60]
                })}),
                L.marker([5.579984, -0.166367], {icon: L.icon({
                  iconUrl: '/img/node.png',
                  iconSize: [40, 60]
                })}),
                L.marker([5.569984, -0.176367], {icon: L.icon({
                  iconUrl: '/img/node.png',
                  iconSize: [40, 60]
                })}),
                L.marker([5.559984, -0.158367], {icon: L.icon({
                  iconUrl: '/img/node.png',
                  iconSize: [40, 60]
                })})
              ]);

              var vessels = L.layerGroup([
                L.marker([5.561233, -0.138804], {icon: L.icon({
                  iconUrl: '/img/vessel.png',
                  iconSize: [40, 60]
                })}),
                L.marker([5.563796, -0.129019], {icon: L.icon({
                  iconUrl: '/img/vessel.png',
                  iconSize: [40, 60]
                })}),
                L.marker([5.560464, -0.141722], {icon: L.icon({
                  iconUrl: '/img/vessel.png',
                  iconSize: [40, 60]
                })}),
                L.marker([5.559695, -0.129191], {icon: L.icon({
                  iconUrl: '/img/vessel.png',
                  iconSize: [40, 60]
                })})
              ]);
              ...
              // Add drawnItems and nodes to the map
