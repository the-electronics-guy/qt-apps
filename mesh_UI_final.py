...
class ChatInterface(QWidget):
    ...
    def send_message(self):
        ...
        self.chat_display.addItem("You: " + message)
    ...
    def gps(self):
        ...
        if node_id in interface.nodes:
            ...
            if latitude is not None and longitude is not None and altitude is not None:
                self.text_edit.append("Latitude:", latitude)
                self.text_edit.append("Longitude:", longitude)
                self.text_edit.append("Altitude:", altitude)
                self.text_edit.append(str(p))
            else:
                self.text_edit.append(f"No position information available for node with ID '{node_id}'")
        else:
    ...
    def setup_stacked_widget(self):
        ...
        widget3_layout.addWidget(self.text_edit)
